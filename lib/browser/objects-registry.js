...
class ObjectsRegistry {
  ...
  add (webContents, obj) {
    ...
    console.log('webcontents', webContents.getId(), 'retain', id, 'counts', counts[id])
  ...
  remove (webContentsId, id) {
    console.log('webcontents', webContentsId, 'remove', id)
  ...
  clear (webContentsId) {
    ...
    console.log('webcontents', webContentsId, 'clear')
  ...
  dereference (id) {
    counts[id] = (counts[id] || 0) - 1
    console.log('release', id, 'counts', counts[id])
